...
if (locationMap) {
  var lat = 51.4533431;
  var lng = -0.1087879;
  (0,_components_maps__WEBPACK_IMPORTED_MODULE_2__.makeMap)(lat, lng);
}
...
function showNewNews(message) {
  ...
  link = link ? "<a href='".concat(link, "'>Find out more</a>") : '';
  var newsContent = "<div class=\"beacon--content\">\n\t\t\t\t\t\t\t<div><span class='font--pink'>NEW</span> ".concat(message, "</div>\n\t\t\t\t\t\t\t<div>").concat(link, "</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t");
  ...
  var nextEl = newsEl.nextElementSibling;
