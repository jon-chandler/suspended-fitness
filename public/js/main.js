...
/* harmony import */ var _utils_stripe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/stripe */ "./js/utils/stripe.js");
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_utils_stripe__WEBPACK_IMPORTED_MODULE_5__]);
var __webpack_async_dependencies_result__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
_utils_stripe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_async_dependencies_result__[0];
...
window.addEventListener('load', function () {
  setTimeout(function () {
    (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.showLoader)(false);
  }, 500);
...
function _initializeStripe() {
  _initializeStripe = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(e) {
    var checkout, data, handleComplete, fetchClientSecret;
            ...
            var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
              ...
              return _regenerator().w(function (_context) {
                while (1) switch (_context.n) {
                  case 0:
                    _context.n = 1;
                    return fetch('http://localhost/session.php', {
                      method: "POST",
                      body: data
                    });
                  case 1:
